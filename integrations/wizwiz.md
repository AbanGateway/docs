...
| زرین‌پال | آدرس خریدار را روی هاست زرین‌پال هاردکد کرده |
| nextpay | همین‌طور |
...
ویزویز مبلغ را به **تومان** نگه می‌دارد — همان چیزی که خودش در فراخوانی nextpay با `currency=IRT` می‌فرستد. ما به ریال صورت‌حساب می‌کنیم و تبدیل دقیقاً یک‌بار، سمت ما، انجام می‌شود.
