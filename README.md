...
| [فاکسیما](integrations/faoxima.md) | درگاه ما داخل خود فاکسیماست: دو مقدار در پنل مدیریت ربات؛ نصب کننده فقط برای نسخه های زیر ۱٫۰ |
...
| [لینک ارزی](guides/fx-link.md) | «دو تتر میفروشم؛ مبلغ را نرخ روز تعیین کند» |
